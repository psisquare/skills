...
> Adapted from [`mattpocock/skills` → `grill-me`](https://github.com/mattpocock/skills/blob/main/skills/productivity/grill-me/SKILL.md), MIT © 2026 Matt Pocock. Adds: functional-only scope, codebase-grounding rails, shared CONTEXT.md glossary, and a structured handoff artifact.
